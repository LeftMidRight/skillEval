...
1. 确认用户提供的是可访问的 PDF URL。
2. 修改 `script/config.yaml`：
...
output:
  ...
  markdown_path: "output/<task-name>/report.md"
  json_path: "output/<task-name>/report_structured.json"
  numbers_path: "output/<task-name>/report_numbers.json"
